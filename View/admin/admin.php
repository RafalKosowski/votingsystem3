    ...
    if ($editedUserData) {
        ...
        <form action="" method="post">
            ...
            <input type="text" id="editedFirstName" name="editedFirstName"
                value="<?= $editedUserData['firstname'] ?>"><br>
            ...
            <input type="text" id="editedPermission" name="editedPermission"
                value="<?= $editedUserData['permission_id'] ?>">
...
if (isset($_POST['editVoteName'])) {
    ...
    if ($editedVoteData) {
        ...
        <form action="" method="post">
            ...
            <input type="text" id="editedVoteName" name="editedVoteName"
                value="<?= $editedVoteData['vote_name'] ?>"><br>
...
<head>
    ...
    <style>
        ...
        .col-6 {
            width: 48%;
            margin-bottom: 20px;
            /* Added margin-bottom to separate columns */
        }
